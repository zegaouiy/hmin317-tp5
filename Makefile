...
CFLAGS        = -std=c++11 -m64 -pipe -O2 -Wall -W -D_REENTRANT -fPIE $(DEFINES)
CXXFLAGS      = -std=c++11 -m64 -pipe -O2 -Wall -W -D_REENTRANT -fPIE $(DEFINES)
INCPATH       = -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I. -I/opt/local/include -I/usr/local/include/libiomp -I/usr/include/qt5 -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
dist: 
	@test -d .tmp/tp51.0.0 || mkdir -p .tmp/tp51.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/tp51.0.0/ && $(COPY_FILE) --parents gestionnaire.qrc .tmp/tp51.0.0/ && $(COPY_FILE) --parents openglwindow.h gamewindow.h .tmp/tp51.0.0/ && $(COPY_FILE) --parents openglwindow.cpp main.cpp gamewindow.cpp .tmp/tp51.0.0/ && (cd `dirname .tmp/tp51.0.0` && $(TAR) tp51.0.0.tar tp51.0.0 && $(COMPRESS) tp51.0.0.tar) && $(MOVE) `dirname .tmp/tp51.0.0`/tp51.0.0.tar.gz . && $(DEL_FILE) -r .tmp/tp51.0.0
...
moc_gamewindow.cpp: /usr/include/qt5/QtGui/QOpenGLShaderProgram \
		...
		gamewindow.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) -I/usr/include/c++/4.8 -I/usr/include/x86_64-linux-gnu/c++/4.8 -I/usr/include/c++/4.8/backward -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include gamewindow.h -o moc_gamewindow.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/home/mewsette/Documents/moteur/hmin317-tp5/. || mkdir -p $(INSTALL_ROOT)/home/mewsette/Documents/moteur/hmin317-tp5/.
	-$(INSTALL_PROGRAM) "$(QMAKE_TARGET)" "$(INSTALL_ROOT)/home/mewsette/Documents/moteur/hmin317-tp5/$(QMAKE_TARGET)"
	-$(STRIP) "$(INSTALL_ROOT)/home/mewsette/Documents/moteur/hmin317-tp5/$(QMAKE_TARGET)"

uninstall_target: FORCE
	-$(DEL_FILE) "$(INSTALL_ROOT)/home/mewsette/Documents/moteur/hmin317-tp5/$(QMAKE_TARGET)"
	-$(DEL_DIR) $(INSTALL_ROOT)/home/mewsette/Documents/moteur/hmin317-tp5/./ 
